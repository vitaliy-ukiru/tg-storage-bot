...
class TextInputProp(WidgetDataObjectABC[T, ManagedTextInput[T]]):
    def process_get(self, widget: ManagedTextInput[T], _=None):  # noqa
        return widget.get_value()

    def process_set(self, widget: ManagedTextInput[T], value: T, _=None):  # noqa
        widget.widget.set_widget_data(widget.manager, str(value))

    def process_del(self, widget: ManagedTextInput[T], _=None):  # noqa
